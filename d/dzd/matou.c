...
int do_leave(string arg)
{
	...
	if(!this_player()->query_temp("job_dzd/dead")) return notify_fail("还没上去就打退堂鼓了啊。\n");
	write("既然如此。。。。。。。\n");
...
int valid_leave(object me,string dir)
{
	...
	oblist1 = ({"jiedu wan","huoxue dan","chantui yao","chuanbei wan","danggui dan","fuling wan","yannian dan","liaojing dan",
			...
			"heishi dan","baicao dan","wulong gao","qingxin san","huxin dan","baola wan","renshen guo","xue lian","budai","bu dai","dahuan dan","da huandan"});
	oblist2 = ({"yitian jian","bing can","bishou"});
