...
void create()
{
	set_name("钱巡捕", ({ "qian xunbu", "qian", "xunbu", "butou"}));
	set("title", HIG"朝廷正九品捕头"NOR);
	set("gender", "男性");
    ...
    set("int", 10);
	set("con", 30+random(5));
	set("long", "他乃是明教弟子，一身武功以达出神入化，名震江湖。\n");
	...
	set_skill("shenghuo-lingfa", 551);
	set_skill("shenghuo-shengong", 551);
	set_skill("qiankun-danuoyi", 551);
	...
	carry_object("clone/weapon/bqling")->wield();
