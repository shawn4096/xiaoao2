...
void create()
{
	...
	set("vendor_goods", ({
            (["name": BINGQI_D("bqsnow_sword"),        "number" : 100]),
            ...
            (["name": BINGQI_D("bqjianxia"),           "number" : 100]),
            (["name": BINGQI_D("bqzhen1"),             "number" : 100]),
	        (["name": BINGQI_D("bqxuesui"),            "number" : 100]),
		    (["name": BINGQI_D("bqsm_ding"),           "number" : 100]),
            (["name": BINGQI_D("bqpanguanbi"),         "number" : 100]),

			(["name": BINGQI_D("bqyinshesword"),       "number" : 100]),
 
			(["name": BINGQI_D("bqstaff"),         "number" : 100]),
			(["name": BINGQI_D("bqling"),         "number" : 100]),
			(["name": BINGQI_D("bqluqi"),         "number" : 100]),
