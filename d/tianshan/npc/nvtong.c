...
void create()
{
        ...
        set_skill("zhemei-shou",500);          //逍遥折梅手(hand)
        set_skill("liuyang-zhang",500);        //天山六阳掌(strike)(unarmed)
        set_skill("yueying-wubu",500);       //凭虚临风(dodge)
        set_skill("bahuang-gong", 500);        //八荒六合唯我独尊功(force)
	    set_skill("tianyu-qijian", 500);     //天山剑法(sword)
