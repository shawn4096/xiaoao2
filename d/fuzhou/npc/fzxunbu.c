...
void create()
{
	set_name("林巡捕", ({ "lin xunbu", "lin", "xunbu", "butou"}));
	set("title", HIY"朝廷正九品捕头"NOR);
	set("gender", "男性");
    ...
    set("int", 40);
	set("con", 30+random(5));
	set("long", "他乃是南少林核心弟子，受掌门委派下山维持治安，一身武功以达出神入化，名震江湖。\n");
	...
	set_skill("qianye-shou", 551);
	set_skill("ruying-suixingtui", 551);
	set_skill("yijin-jing", 551);
	...
	set("quest/sl/rysxt/tiezhou/pass",1);
	set("quest/sl/qys/pass",1);
	set("quest/sl/rysxt/pass",1);
	set("max_qi", 35000);
	set("max_jingli", 8000);
	set("eff_jingli", 8000);
	set("eff_jing", 6000);
