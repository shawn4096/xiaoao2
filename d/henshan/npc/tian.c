...
int ask_kuaidao()
{
		...
		&&i<4)
	{
	   ...
	   +"田伯光点头说道，“这一招全凭一口真气流转，快速出招，能有多快要多快，否则，对方趁势反击，你就危险了。”\n"NOR,me);
	    message_vision(HIR"\n\n恭喜你！你终于领悟了狂风快刀的精髓武技，习得狂风快刀绝技。\n"NOR,me);
		command("chat* haha"+me->query("id"));
	   command("chat "+me->query("name")+"用了这么长时间终于领悟了狂风快刀绝技。");
	   command("chat "+"我万里独行田伯光的狂风快刀绝技终于有传人了！。\n");
	   ...
	   me->set("title",HIW"非不可不戒"NOR);
	   me->set("mytitle/quest/kdtitle",HIW"非不可不戒"NOR);
	   me->start_busy(1);
