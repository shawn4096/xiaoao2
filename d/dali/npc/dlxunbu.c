...
void create()
{
	set_name("孙巡捕", ({ "sun xunbu", "sun", "xunbu", "butou"}));
	set("title", HIR"朝廷正九品捕头"NOR);
	set("gender", "男性");
    ...
    set("int", 10);
	set("con", 30+random(5));
	set("long", "他乃是大理弟子，一身武功以达出神入化，名震江湖。\n");
	...
	set_skill("qiantian-yiyang", 550);
	set_skill("tianlong-xiang", 550);	
	...
	set("quest/tls/zhijian/pass",1);
	set("quest/tls/yyz/sandie/pass",1);
	set("env/一阳指","三叠");
	set("max_qi", 35000);
	set("max_jingli", 9000);
	set("eff_jingli", 9000);
    ...
    set("chat_msg_combat", ({
				...
				(: perform_action, "finger.qianlong" :),
				(: perform_action, "finger.zhijian" :),
