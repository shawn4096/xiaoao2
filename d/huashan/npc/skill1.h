...
//set killer's skill
        ...
        me->set_skill("huashan-qigong",number_t);
        me->set_skill("huashan-shenfa",number_t);
		me->set_skill("dugu-jiujian",number_t);
        //me->set_skill("chongling-jian",number_t);
			 ...
			 && weapon->query("skill_type") == "sword")
				weapon->unequip();
            		if (weapon = present("chang jian",me))
            			...
            			carry_object(BINGQI_D("chang jian"))->wield();
            		break;
	}
// set killer's  skill maps
        me->map_skill("force","huashan-qigong");
