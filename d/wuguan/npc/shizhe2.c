...
#define SKILLS_LEVEL            351

#define KNOWLEDGE_LEVEL         300

#define GIVE_EXP                4500000

#define MAX_NEILI               10000

#define MAX_JINGLI              5000
...
void create()
{
    set_name(HIY"书剑礼物使者(小飞)"NOR, ({ "shizhec" }));
