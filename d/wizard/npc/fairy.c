...
int ask_gold_tb()
{
        ...
        {
                      command("say 你的"HIY"黄金存款"NOR"不足一千两，无法兑换"HBGRN+HIG"书剑通宝"NOR"。\n");
        ...
        tell_object(me,HIC"\n你成功将"HIY"一千锭黄金"HIC"存款转换为一百个"HBGRN+HIG"书剑通宝"NOR+HIC"！\n"NOR);
      return 1;
}
...
int ask_tb_gold()
{
        ...
        {
                      command("say 你的"HBGRN+HIG"书剑通宝"NOR"不足一百个，无法兑换"HIY"黄金存款"NOR"。\n");
                return 1;        	
        }
        ...
        tell_object(me,HIC"\n你成功将一百个"HBGRN+HIG"书剑通宝"NOR+HIC"转换为"HIY"一千锭黄金"HIC"存款！\n"NOR);
      return 1;
}
