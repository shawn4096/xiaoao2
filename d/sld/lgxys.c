...
void reset()
{
	...
	//set("yaozhong",15);
		...
		new("d/sld/npc/obj/yaocao")->move(con);
		new("d/sld/npc/obj/yaocao")->move(con);
		new("d/sld/npc/obj/yaocao")->move(con);
		new("d/sld/npc/obj/yaocao")->move(con);
		new("d/sld/npc/obj/yaocao")->move(con);
		new("d/sld/obj/caoyaojing")->move(con);
}    	
...
int do_search(string arg)
{
	...
	if(!me->query_temp("sld/zhongyao/start",1))
	{
	...
	if((arg!="角落") && (arg!="corner") && (arg!="墙角") && (arg!="屋角")&& (arg!="药种"))
		return 0;
	...
	if(me->query("jingli")<50)
		...
		me->add("jingli",-50);
	if(present("yao zhong",me))
		return notify_fail("你身上不是已经有一枚药种了么。\n");
	if(me->query_temp("sld/zhongyao/findyz"))
		return notify_fail("你已经找到过一枚药种了么。\n");
	...
	//{
		...
		//add("yaozhong",-1);
		//if(!me->query_temp("findyz"))
			me->set_temp("sld/zhongyao/findyz",1);
			me->add_busy(2);
		//else
			//me->add_temp("findyz",1);
		return 1;
