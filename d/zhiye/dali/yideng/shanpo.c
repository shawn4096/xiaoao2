   ...
   /*
	if (me->query_temp("nqg/askyingok"))
    {
	   if (!objectp(ob))
		...
		tell_object(me,"农夫「嘿嘿嘿」奸笑了几声。\n ");
		
		tell_object(me,"\n\n看不出来啊，人品到是挺好，好像是有那么回事似的，居然是一副道貌岸然的样子！\n");
		tell_object(me,"\n\n 好小子，还真不赖，居然从老四和老三那边跑了过来！\n");
		tell_object(me,"\n\n纳命来吧！");
		tell_object(me,HIR"\n\n\n这个农夫不知道发了什么疯，对你开始痛下狠手！\n"NOR);
		ob->kill_ob(me);
		me->start_busy(-1);
		message_vision(HIY"\n\n\n\$N眼见局势危机，急忙运功将这石头掀翻，和$n打了起来。\n", me,ob);
		me->kill_ob(ob);
...
int check_jiaozi(object me)
{
	...
	message_vision("你哼了一声道，让你给我装。你运功将这石头掀翻，找到了前进的道路。\n", me);
	return 1;
