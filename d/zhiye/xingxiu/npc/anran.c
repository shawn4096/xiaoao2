...
void create()
{
        ...
        set_skill("force", 230);
        set_skill("huagong-dafa", 230);
        set_skill("dodge", 230);
        set_skill("zhaixingshu", 230);
        set_skill("strike",230);
        set_skill("chousui-zhang", 230);
        set_skill("poison", 110);
        set_skill("parry", 230);
        set_skill("staff", 230);
        set_skill("tianshan-zhang", 230);
        set_skill("literate", 70);
        set_skill("claw", 230);
        set_skill("sanyin-zhua", 230);
