...
{   
	...
	//设置嫡传标记
	if (random(me->query("job_time/星宿熬膏"))>500 && random(me->query_kar())>25&& !me->query("quest/xx/dichuan"))
	{
		command("say 真不错，老仙跟我说了，让我好好发现门中的好苗子，就是你了！\n");
		command("pat "+me->query("id"));
		me->set("title","星宿派嫡传弟子");
		me->set("quest/xx/dichuan",1);
	}
