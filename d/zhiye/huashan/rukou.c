...
int do_use(string arg)
{
	...
	/*	if (me->query_temp("hssb/findmimi"))
		{
		...
		if (me->query_temp("hssb/juejiasked"))
		{
		   message_vision(HIC"微弱的火光一闪一闪的。你发现左边"HIG"(left)"HIC"好象有个小口可以过去。\n"NOR, me);
		...
		call_out("delete_exit", 4, me);   
		return 1; 
	}
}

void delete_exit(object me)
{     
    message_vision("$N只听见扑的一声，火折熄灭了。\n", me);  
