...
void create()
{
        ...
        set("nickname","掌门师弟小剑客");
        set("long", "乍看上去只不过是一个平凡的小矮子，但目光凶恶逼人。\n");
        set("age", 40);
...
{
        mapping fam;
        if (!ob->query("family") && ob->query("family/family_name")!= "华山派"  && (int)ob->query("is/huashan")==1 ) {
