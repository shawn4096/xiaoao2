...
void create()
{
	set_name("胡巡捕", ({ "hu xunbu", "hu", "xunbu", "butou"}));
	set("title", HIW"朝廷正九品沧州捕头"NOR);
	set("gender", "男性");
    ...
    set("int", 40);
	set("con", 30+random(5));
	set("long", "他乃是全真教核心弟子，受掌门委派下山维持治安，一身武功以达出神入化，名震江湖。\n");
	...
	set_skill("xiantian-gong", 551);
	set_skill("quanzhen-jianfa", 551);
	set_skill("haotian-zhang", 551);
