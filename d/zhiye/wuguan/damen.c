...
LONG
 ...
 "/d/wuguan/npc/shizhe0" : 1,
 "/d/wuguan/npc/shizhe1" : 1,
 "/d/wuguan/npc/shizhe2" : 1,
 "/d/wuguan/npc/shizhe3" : 1,
 "/d/wuguan/npc/shizhe4" : 1,
	...
	if ( dir == "enter" && !wizardp(me)) {
		...
		if ( me->query("combat_exp") > 3000 )
		{
			...
			if(me->query_temp(QUESTDIR2+"start"))
			{
				...
				return notify_fail("门卫上前把手一伸：那有这么好的事情，在武馆?龀觥n");
			}
			obj = users();
			x = sizeof(obj);
			while(x--)
