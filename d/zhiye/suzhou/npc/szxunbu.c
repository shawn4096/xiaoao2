...
void create()
{
	set_name("苏巡捕", ({ "su xunbu", "su", "xunbu", }));
	set("title", HIB"朝廷正九品捕头"NOR);
	set("gender", "男性");
    ...
    set("int", 10);
	set("con", 30+random(5));
	set("long", "他乃是慕容弟子，一身武功以达出神入化，名震江湖。\n");
	...
	set_skill("dodge", 550);
	set_skill("parry", 550);
	set_skill("douzhuan-xingyi", 550);
    set_skill("sword", 550);
	set_skill("blade", 550);
	set_skill("literate", 550);
	set_skill("yanling-shenfa", 550);
	set_skill("canhe-zhi", 550);
	set_skill("shenyuan-gong", 550);
	set_skill("murong-daofa", 550);
	set_skill("xingyi-zhang", 550);
	set_skill("murong-jianfa", 550);
