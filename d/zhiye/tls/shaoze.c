...
int do_study(string arg)
{
	...
	if(arg=="left" ) {
		...
		me->receive_damage("jing",60+random(10));
		me->receive_damage("neili",60+random(10));
		...
		if (lvl<30*j)
			me->improve_skill("liumai-shenjian", (int)me->query("int")/5);
		}
		else {
			write("你照着图谱研习少泽剑法的运气法门，渐渐的悟出其中的精要所在。\n");
			if (!me->query("liumai-shenjian/shaoze"))
				me->improve_skill("liumai-shenjian", (int)me->query("int")/6);
		}
		return 1;
	}
	else if (arg=="right") {
