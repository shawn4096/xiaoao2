...
long);
	set("xyjob", 1);
	set("exits",([
		"tiandi" : __DIR__"/leitai/lt",
		"fengyun" : __DIR__"/leitai/lt1",
		"longhu" : __DIR__"/leitai/lt2",
		"north" : __DIR__"bcx2",
	]));
	set("outdoors", "襄阳");
	set("incity",1);
...
int valid_leave(object me,string dir)
{
	...
	if (dir == "north" && me->query("db_time",1) > 0 ){
		me->apply_condition("db_exp",me->query("db_time",1)); 
		//注意这里不能引用db_time,因为db_time是在玩家最后一次抵达这个地点的时候采集的，如果从擂台出来，那么db_time必然是0
		me->delete("db_time");
	}
