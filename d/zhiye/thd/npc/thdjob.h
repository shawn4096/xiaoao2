...
int accept_object(object who, object ob)
{
		...
		//判断嫡传
		if (random(who->query("job_time/桃花岛"))>400 && random(who->query("kar"))>25 && !who->query("quest/thd/dichuan"))
		{
			message_vision(HIC"黄蓉对$N白了一眼说道，看你这么辛苦为我桃花岛守墓，我爹跟我说了，你已经通过测试了。\n"NOR,who);
			who->set("title","桃花岛嫡传弟子");
			who->set("quest/thd/dichuan",1);
		}
		if (who->query("quest/thd/dichuan"))
		{
			who->set("title","桃花岛嫡传弟子");
		}
