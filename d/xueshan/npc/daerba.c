...
string ask_master()
{
	...
	if (ob->query("family/generation") > 12 )
	...
	if ((int)ob->query_skill("mizong-fofa", 1) < 120) {
		command("say 雪山大轮寺密宗佛法天下无双。");
		return " 在密宗佛法方面，" + RANK_D->query_respect(ob) + "修行的还不够吧？\n";
	}
