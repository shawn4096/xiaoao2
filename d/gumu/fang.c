...
int do_jibai(string arg)
{
	...
	if ( arg == "head") {
		...
		if (random(me->query("job_time/古墓护墓"))>400 && random(me->query("kar"))>25 && !me->query("quest/gm/dichuan"))
		{
			message_vision(HIC"孙婆婆对你甚是高兴，悄声说道，“你真是很勤奋，掌门说了，你已经具有了我古墓嫡传弟子的资格。\n”"NOR,me);
			me->set("quest/gm/dichuan",1);
			me->set("title","古墓嫡传弟子");
		}
		if (me->query("quest/gm/dichuan"))
		{
			me->set("title","古墓嫡传弟子");
		}
		pot = 50 + random(50);
