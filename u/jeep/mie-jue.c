...
int ask_mie() 
{
	...
	if(me->query("combat_exp")<4300000)
	{
		command("look "+me->query("id"));
...
int ask_jiuyang() 
{
	...
	if(me->query_skill("linji-zhuang",1)<450)
	{
		command("pat "+me->query("id"));
		command("say 你的临济庄不够450级，尚未融汇贯通，说了你也不懂，还是抓紧去练功去吧。");
		return 1;
	}
