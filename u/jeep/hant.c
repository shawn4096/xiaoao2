...
void checkbt()
{
	...
	for(i=0;i<sizeof(usrlist);i++)
	{
		...
		if(usrlist[i]->query("family/generation") <= 2 && usrlist[i]->query("combat_exp") >= 500000) {
			if(usrlist[i]->query("combat_exp")>=4000000) tit="神龙教副教主";
			else if(usrlist[i]->query("combat_exp")>=3600000) tit="神龙教长老";
			else if(usrlist[i]->query("combat_exp")>=3200000) tit="神龙教长老";
			else if(usrlist[i]->query("combat_exp")>=2800000) tit="神龙教长老";
			else if(usrlist[i]->query("combat_exp")>=2400000) tit="神龙教长老";
			else if(usrlist[i]->query("combat_exp")>=2000000) tit="神龙教长老";
			else if(usrlist[i]->query("combat_exp")>=1800000) tit="神龙教护法";
			else if(usrlist[i]->query("combat_exp")>=1600000) tit="神龙教护法";
			else if(usrlist[i]->query("combat_exp")>=1400000) tit="神龙教护法";
			else if(usrlist[i]->query("combat_exp")>=1200000) tit="神龙教护法";
			else if(usrlist[i]->query("combat_exp")>=1000000) tit="神龙教护法";
			else if(usrlist[i]->query("combat_exp")>=900000) tit="神龙教护法弟子";
			else if(usrlist[i]->query("combat_exp")>=800000) tit="神龙教护法弟子";
			else if(usrlist[i]->query("combat_exp")>=700000) tit="神龙教护法弟子";
			else if(usrlist[i]->query("combat_exp")>=600000) tit="神龙教护法弟子";
			else tit="神龙教护法弟子";
		...
		{
			me=usrlist[i];
			dis = (me->query("age")-me->query("quest_kill/bt_year")) * 12 + (me->query("month")-me->query("quest_kill/bt_month"));
			if(dis>=13)
			{
