...
int ask_job()
{
	...
	if(!me->is_team_leader())
	{
       ...
       if  (me->query("fuben/kangqing/time") && time()-me->query("fuben/kangqing/time") < 86400 )
{
    tell_object(me,"一天只能进一次副本。\n");
		return 1;
	}
...
time()-team[i]->query("fuben/kangqing/time") <86400 )
   {
		tell_object(me,"你队伍中有人已经超过每日副本限制，请另找高明。\n");
		return 1;
	}
