...
void create()
{
	...
	set("vendor_goods", ({
		(["name":"/clone/zhiye/buliao1","number":150]),
		(["name":"/clone/zhiye/buliao2","number":150]),
		(["name":"/clone/zhiye/buliao3","number":150]),
		(["name":"/clone/zhiye/buliao4","number":150]),
	}));

	setup();
	carry_object(ARMOR_D("cloth"))->wear();
	carry_object("/clone/zhiye/fangsuo")->wield();
	add_money("coin",99);
}
