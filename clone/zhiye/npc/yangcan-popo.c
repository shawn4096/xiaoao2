...
现在老了就卖些工具，教教年轻人过活。\n");
	...
	set("vendor_goods", ({
		(["name":"/clone/zhiye/jiandao","number":99]),
		(["name":"/clone/zhiye/tieqiao","number":20]),
		(["name":"/clone/zhiye/liandao","number":20]),
		(["name":"/clone/zhiye/saoba"  ,"number":20]),
		(["name":"/clone/zhiye/zhongzi1","number":50]),
		(["name":"/clone/zhiye/zhongzi2","number":50]),
		(["name":"/clone/zhiye/zhongzi3","number":50]),
		(["name":"/clone/zhiye/zhongzi4","number":50]),
		(["name":"/clone/zhiye/zhongzi5","number":50]),
		(["name":"/clone/zhiye/zhongzi6","number":50]),
		(["name":"/clone/zhiye/zhongzi7","number":50]),
		(["name":"/clone/zhiye/zhongzi8","number":50]),
		(["name":"/clone/zhiye/zhongzi9","number":50]),
	}));
	...
	carry_object("/clone/zhiye/jiandao")->wield();
	add_money("coin",99);
}
