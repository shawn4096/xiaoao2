...
string query_rank(object ob)
{
    ...
    case "恒山派":
		...
		case "大轮寺": budd = ob->query_skill("mizong-fofa", 1); break;
		...
		case "白驼山庄": budd = ob->query_skill("hamagong", 1);	break;
		case "血刀门": budd = ob->query_skill("huanxi-chan", 1);	break;
		...
		case "雌性":
				...
				default:
					...
					switch(fname) {
						...
						case "峨嵋派":
							...
							return HIW "【 学戒女 】" NOR;
						case "大轮寺":
							if (budd >= 180 && shen >= 0) return HIY "【 女法王 】" NOR;
							if (budd >= 180 && shen < 0) return HIY "【 魔王女 】" NOR;
							if (budd >= 140) return HIW "【 金刚女 】" NOR;
							if (budd >= 90)  return HIW "【 飞天女 】" NOR;
							if (budd >= 60) return HIW "【 乾达婆 】" NOR;
							if (budd >= 30 || age >= 20) return HIW "【 女喇嘛 】" NOR;
							return HIW "【 授  事 】" NOR;
						case "逍遥派":
						    if (budd >= 580) return HIW "【 神  剑 】" NOR;
							if (budd >= 440) return HIY "【 圣  剑 】" NOR;
							if (budd >= 300) return HIC "【 名  剑 】" NOR;
							if (budd >= 200 || age >= 18)  return YEL "【 侍  剑 】" NOR;
							return GRN "【 剑  童 】" NOR;						
            ...
            case "恒山派":
						...
						case "全真教":
							...
							return GRN "【 小道姑 】" NOR;
						case "铁掌帮":
							if (budd >= 180) return WHT "【压寨夫人】" NOR;
							if (budd >= 140) return HIC "【 母大虫 】" NOR;
						...
						case "星宿派":
							...
							return GRN "【 马屁虫 】" NOR;
						case "姑苏慕容":
							if(budd >= 190) return HIC "【 大小姐 】" NOR;
							if(budd >= 150) return HIC "【 庄  主 】" NOR;
							if(budd >= 110) return HIC "【 管家婆 】" NOR;
							if(budd >= 70) return HIC "【 侍  书 】" NOR;
							if(budd >= 30) return HIC "【 大丫鬟 】" NOR;
							return HIC "【 丫  鬟 】" NOR;
						case "欧阳世家":
							if(budd >= 500) return HIR "【 女西毒 】" NOR;
							if(budd >= 400) return HIB "【 女蛇魔 】" NOR;
							if(budd >= 300) return HIC "【 女总管 】" NOR;
							if(budd >= 20) return HIM "【 女护院 】" NOR;
						...
						case "白驼山庄":
							...
							if(budd >= 400) return HIB "【 女蛇魔 】" NOR;
							if(budd >= 300) return HIC "【 女总管 】" NOR;
							if(budd >= 200) return HIM "【 女护院 】" NOR;
							if(budd >= 30) return MAG "【 女随从 】" NOR;
							return GRN "【 女家丁 】" NOR;
						case "日月神教":
					...
					switch(fname) {
						...
						case "天龙寺":
							if (ob->query("tls")) {
								...
								if (ob->query("qinwang") || ob->query("family/master_name")=="一灯大师")
									return HIY "【 王  爷 】" NOR;
							...
							return HIW "【 管  差 】" NOR;
						case "峨嵋派":							
							if (budd >= 180) return HIW "【 大长老 】" NOR;
							if (budd >= 140) return HIW "【 卿长老 】" NOR;
							if (budd >= 90)  return HIW "【 剑  侣 】" NOR;
							if (budd >= 60) return HIW "【 剑  人 】" NOR;
							if (budd >= 30 || age >= 20) return HIW "【 剑  宾 】" NOR;
							return HIW "【 剑  童 】" NOR;
						case "大轮寺":
							if (budd >= 180)
								if (shen >= 0) return HIY "【 法  王 】" NOR;
								else return HIY "【 魔法王 】" NOR;
							if (budd >= 140) return HIY "【 天  王 】" NOR;
							if (budd >= 120) return HIY "【 飞  天 】" NOR;
						...
						//只有男性
						case "血刀门":
							if(budd >= 190) return HIR "【 活 佛 】" NOR;
							if(budd >= 150) return HIM "【 铁杖喇嘛 】" NOR;
							if(budd >= 110) return HIC "【 翁 增】" NOR;
							if(budd >= 70) return HIG "【 哈尔巴 】" NOR;
							if(budd >= 30) return GRN "【 格洛喇嘛 】" NOR;
							return GRN "【 格楚喇嘛 】" NOR;

						case "姑苏慕容":
							if(budd >= 190) return HIC "【 大少爷 】" NOR;
							if(budd >= 150) return HIC "【 庄  主 】" NOR;
							if(budd >= 110) return HIC "【 家  将 】" NOR;
							if(budd >= 70) return HIC "【 门  客 】" NOR;
							if(budd >= 30) return HIC "【 家  奴 】" NOR;
							return HIC "【 庄  丁 】" NOR;
						case "欧阳世家":
							if(budd >= 500) return HIB "【 西  毒 】" NOR;
							if(budd >= 400) return HIB "【 蛇  魔 】" NOR;
							if(budd >= 300) return HIC "【 总  管 】" NOR;
							if(budd >= 200) return HIM "【  护  院 】" NOR;
