...
void create()
{
        ...
        set_skill("sword", 550);
        set_skill("quanzhen-jianfa",550);
        set_skill("dodge", 550);
        set_skill("jinyan-gong", 550);
        set_skill("parry", 550);
        set_skill("kongming-quan", 550);
        set_skill("strike", 550);
        set_skill("haotian-zhang", 550);
        set_skill("dafumo-quan", 550);
        set_skill("jiuyin-zhengong", 550);
        set_skill("jiuyin-shenfa", 550);
        set_skill("jiuyin-shenzhua", 550);
        set_skill("daode-jing", 550);
        set_skill("claw", 550);
        set_skill("cuff", 550);
        set_skill("literate", 300);
        set_skill("taoism", 220);
        set_skill("tiangang-beidouzhen", 500);
        set("double_attack",1);
...
int zhou_say1()
{
	command("say 我老顽童这一生谁都敢见，我曾怕过谁？\n");
	command("say 但唯独有两个是是例外的，一个是大理国段皇爷，另外一个是他的贵妃瑛姑？\n");
	command("say 你要我让我见谁？\n");
	command("shake ");
	command("say 老顽童行事卑鄙下流，对不起他二人，因此没脸和他们相见。\n");
	return 1;
}