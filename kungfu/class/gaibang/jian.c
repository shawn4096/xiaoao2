...
void create()
{
	...
	set_skill("force", 440); // 基本内功
	set_skill("huntian-qigong", 440); // 混天气功
	set_skill("hand", 440); // 基本拳脚
        set_skill("suohou-shou", 440);
	set_skill("dodge", 440); // 基本躲闪
        set_skill("xiaoyaoyou", 440); // 千里行乞
	set_skill("parry", 440); // 基本招架
        set_skill("stick", 100);
