...
void do_teach(object oyf, object me)
{
		...
		if(!me || environment(me) != environment(this_object())) return;
      	...
      	if(me->query("con") < 22) {
				...
				me->set("family/family_name","白驼山庄");
				me->set("family/master_name","欧阳锋");
				me->set("family/master_id","ouyang feng");
				
             	add_exp(me);  
				me->delete_skill("huashan-qigong");
				me->delete_skill("zixia-gong");
				me->delete_skill("guiyuan-tunafa");
				me->delete_skill("yinyun-ziqi");
				me->delete_skill("yijin-jing");
				me->delete_skill("linji-zhuang");
				me->delete_skill("xuantian-wuji");
				me->delete_skill("qiantian-yiyang");
				me->delete_skill("kurong-changong");
				me->delete_skill("shenghuo-shengong");
				me->delete_skill("dulong-dafa");
				me->delete_skill("bihai-chaosheng");
				me->delete_skill("longxiang-boruo");
				me->delete_skill("huntian-qigong");
				me->delete_skill("shenyuan-gong");
				me->delete_skill("huagong-dafa");
				me->delete_skill("xiantian-gong");
				me->delete_skill("yunu-xinjing");
				me->delete_skill("xixing-dafa");
				me->delete_skill("tianmo-gong");
				me->delete_skill("beiming-shengong");
				me->delete_skill("bahuang-gong");
				me->delete_skill("xiantian-gong");

				tell_object(me, "你已经成为白驼山庄的一员！\n");
...
void do_leave(object me)
{
	...
	me->set("mytitle/quest/baituo1title",HIW"白驼山庄"MAG"欧阳锋义子"NOR);
