...
int valid_combine(string combo){return combo=="jiuyin-shenzhua";}
...
int hit_ob(object me, object ob, int damage)
{
	...
	ob->set("jiali",0);
	return 0; ; z个饭吃饱穿        mbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbs
int hit_ob(object me, object ob, int damage)
{
        message_vision(HIR"$N被九阴真气一震，方寸大乱！\n"NOR,ob);
        ob->add("jingli",-random(500));
        ob->set("jiali",0);
        return 0;
}
*/
