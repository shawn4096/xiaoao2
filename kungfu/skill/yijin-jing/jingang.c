...
{    
	 ...
	 // me->set_temp("jingang/fanzhen");
	  ...
	  {
		  message_vision(HBYEL+HIW"$N易筋经已然大成，融会贯通，金刚不坏体神功的大威力此时放得以显现出来。\n"NOR,me);
...
string exert_name(){ return HIY"金刚不坏体"NOR; }
...
int help(object me)
{
	...
	抗击外力。若解开易筋经神功最终秘密，则金刚不坏体神功将彻底大乘。
