...
HIC"$N左斜行三步，运使「少泽剑法」，右手食指虚点，左手小指突然点出，内力自左向右的斜攻过去，直插$n的$l！"NOR,
HIC"$N手臂陡然一提，在手掌离$n不到一尺之处，使一招「少泽剑法」,立即翻腕向上，屈掌成拳，小指弹出！"NOR,
HIC"$N左手小指上翘，「少泽剑法」灵动异常，忽屈忽伸，连续划圈，发出无数劲风！"NOR,
HIC"$N身体一蹲，使出「少泽剑法」，小指上伸，轻轻弹出，一股无形指风打向$n的$l！"NOR,
});
string *guanchong = ({
//关冲
MAG"$N长笑一声，俯身斜倚，「关冲剑法」由无名指弹出，指尖已对准$n的$l发出了一缕强烈的劲风！"NOR,
MAG"$N运使「关冲剑法」，无名指一挥，拙滞古朴的关冲剑气直射而出，端端正正地刺向$n！"NOR,
MAG"$N身体一转，手臂向后伸出，无名指遥遥一指，剑气破空，「关冲剑法」劲气直向$n的$l！"NOR,
MAG"$N食指一收，无名指突然点出，「关冲剑气」一发，一条剑气直射而出，快捷无比！"NOR,
MAG"$N双掌交错，缓缓伸出无名指，「关冲剑法」发出，突然间剑气纵横，一股剑气由无名指”嗤“的一声射出！"NOR,
});
string *shangyang = ({
//商阳
HIG"$N变招奇速，使出「商阳剑法」，右手食指如毒蛇出洞，疾从袖底穿出，大喝一声，双手幻出无数指影！"NOR,
HIG"$N拇指一屈，食指点出，变成了「商阳剑法」，一缕剑气向$n刺出！"NOR,
HIG"$N食指连动，「商阳剑法」一剑又一剑的刺出，其轻灵迅速，快速无比！"NOR,
HIG"$N驱使「商阳剑法」，以食指运那无形剑气，却不过是手指在数寸范围内转动，对着$n一点一戳！"NOR,
HIG"$N使出「商阳剑法」，食指忽屈忽伸，每一下点出，都是一缕无形指风似剑刺出！"NOR,
});
string *zhongchong = ({
//中冲
HIR"$N身体一转，中指反手划出，「中冲剑法」犹如长风破浪，一道剑气如刀般向前攻出！"NOR,
HIR"$N身形一恭，双手前伸，一式「中冲剑法」,双手合使，两道凌厉无比的剑气破空刺出！"NOR,
HIR"$N脸色森然，中指一竖，一挑，一式「中冲剑法」,两道剑气交错而行，向前刺出！"NOR,
HIR"$N将中指向上一弹，波的一声，「中冲剑法」劲气汹涌而出，接着$P将手指向下一划，剑气如利刀般砍向$n！"NOR,
HIR"电光火石之间，$N一翻掌，使出「中冲剑法」，身向右移，奋起神威，右手斗然探出，中指向$n一竖！"NOR,
});
string *shaochong = ({
//少冲
CYN"$N掌托于胸前，伸出右小指，一招「少冲剑法」,缓缓地点向$n的周身大穴，弹指无声！"NOR,
CYN"$N小指一弹，以「少冲剑法」使一招‘分花拂柳’，剑势如同柳絮一般，飘而不乱！"NOR,
...
string *shaoshang = ({
//少商
HIB"$N大拇指一按，运使「少商剑法」嗤嗤两指，劲道使得甚巧，初缓后急，剑气如怒潮般汹涌而至！"NOR,
