...
mapping query_action(object me, object weapon)
{
	...
	if(me->query_temp("qyz/qingyan")){
		switch(me->query_temp("qyz/qingyan")){
			case 4: msg = MAG"$N左手向前斜劈，一道锐利的掌风划过空气，＂哗＂的一声在$n的身前散成"+chinese_number(b)+"道掌力，分袭各处要害" NOR;break;
			case 3: msg = BLU"$N凌空下击，回剑入鞘，右掌向左一削，左掌向右一砍，两道交叉的无形掌力，直逼$n身前要害" NOR;break;
			case 2: msg = CYN"$N人在空中，掌法使的行云流水，＂叭＂的一声，一掌按出，又是"+chinese_number(b)+"道掌力分散开笼罩$n的全身" NOR; break;
			case 1: msg = YEL"$N袖子一摆，掌式轻柔，犹如风中落叶，连拍"+chinese_number(b)+"下，数道掌力交织成一道无形的气网，缓缓推向$n"NOR;break;
			default: msg = WHT"$N双手舞动，阴柔劲力汹涌，瞬间又前后左右连拍数下，凝聚真气，缓缓推向$n" NOR; break;
		}
