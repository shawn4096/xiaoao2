...
int exert(object me, object target)
{
	...
	message_vision(HBGRN+HIW "只见$N鼻中吐出来的白气缠住$N脑袋周围，缭绕不散，渐渐愈来愈浓，成为一团白雾，将$N面目都遮没了，\n"
...
void remove_effect(object me, int count)
{
	...
	if( objectp(me) && me->query_temp("bhg/duzun") ) {
     ...
     me->delete_temp("bhg/duzun");
		message_vision(HIR"$N爆豆声渐轻渐稀，跟着那团白雾也渐渐淡了，见$N鼻孔中不断吸入白雾，待得白雾吸尽，那$N睁开双眼，缓缓站起。\n"NOR,me);
	}
}
