...
int help(object me)
{
	write(HIW"\n八荒六合唯我独尊功之「弹字诀」："NOR"\n\n");
        write(@HELP
	虚竹子在解救天山童姥的过程中，受童姥指使，学习了无上内功运使法门。
	尤其是在打跑外岛岛主的追逐过程中，以松球代替暗器，运使八荒六合劲
	打的诸路英豪狼奔豕突。弹字诀的劲力运使法门起到关键性作用。
	弹字诀，在小飞前，因技能所限只能弹出三道劲气，大飞前能弹出六道劲气
	大飞后，能弹出十二道劲气。所以这门功法主要是判断双方内力强弱，内力
	或内功越是强大，命中和伤害越高。
	注意的是，500级前，因功力不到，所以需要手持暗器，但是当500级后且功
	力贯通若解开密室中闭关第三段，则可以达到飞花摘叶伤人于无形的地步。
	要求：
		最大内力  3000 以上；
		当前内力  1200  以上；
		当前精力  1000  以上；
