...
int perform(object me)
{
        ...
        if((random(ap) > dp/2)
         ...
         || me->query_temp("honglian/lianxu")){
           ...
           if(me->query_temp("honglian/lianxu")){
           	msg +=HIW"$N将体内激荡之内劲击出，顿时$n火势顿增，$n不住挣扎，已经"HIR"无力出招"HIW"了！\n"NOR;
           	target->apply_condition("no_force",(me->query_skill("huoyan-dao,1")/50+random(5)));}
