...
int update_condition(object me, int duration)
{
	...
	me->receive_wound("jing", 200 - random(me->query_con()), "星宿毒发精血受损");
	me->add_busy(2); 
...
int update_condition(object me, int duration)
{
   ...
   me->receive_wound("qi", 250 - resist - random(me->query_con()), "星宿毒发气血受损");
   me->receive_wound("jing", 150 - random(me->query_con()), "星宿毒发精血受损");
